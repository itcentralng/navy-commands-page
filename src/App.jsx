...
const App = () => {
  ...
  return (
    ...
    >
      <video src="/flag.mp4" autoPlay muted loop style={{ height: "100%", position: "absolute", zIndex: 1, width: "100%" }}></video>
      <div style={{ position: "absolute", zIndex: 2, top: 0, right: 0, left: 0, bottom: 0, width: "100%", backgroundColor: "rgba(000,000,000,0.6)", overflow: "hidden" }}></div>
